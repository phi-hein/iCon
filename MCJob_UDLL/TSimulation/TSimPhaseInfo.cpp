...
int TSimPhaseInfo::SaveToStream (ostream &output, int offset, string start_key, string end_key) {
...
int TSimPhaseInfo::LoadFromStream (istream &input, int lattice_size, int stack_size, int movstack_size, string end_key) {
