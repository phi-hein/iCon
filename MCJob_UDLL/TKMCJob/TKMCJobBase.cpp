...
// Usernamen eingeben
int TKMCJobBase::SetUserName (string Name) {try {
	// Input prüfen
...
int TKMCJobBase::SetProjectDate () {try {
...
int TKMCJobBase::SetProjectDescription (string Description) {try {
	// Input prüfen
...
int TKMCJobBase::SaveToFile (string Filename) {try {
	if (Ready != true) {
	...
	// Datei oeffnen
	ofstream outfile (Trim(Filename));
...
int TKMCJobBase::SaveToString (string &Output) {try {
	if (Ready != true) {
...
// Job aus Datei laden
int TKMCJobBase::LoadFromFile (string Filename) {try {
	if (Ready != true) {
...
int TKMCJobBase::LoadFromString (string Input) {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearElements () {try {
	if (Ready != true) {
...
int TKMCJobBase::AddElement (string ElementSymbol, string ElementName, double ElementCharge) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetMovingElement (string ElementSymbol, string ElementName, double ElementCharge) {try {
	if (Ready != true) {
...
int TKMCJobBase::MakeElements () {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearStructure () {try {
	if (Ready != true) {
...
int TKMCJobBase::SetStructureName (string StructureName) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetBasisByLatticeParam (double LengthA, double LengthB, double LengthC, double AngleA, double AngleB, double AngleC) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetBasisByLatticeVectors (double Ax, double Ay, double Az, double Bx, double By, double Bz, double Cx, double Cy, double Cz) {try {
	if (Ready != true) {
...
int TKMCJobBase::AddAtom (double Xrel, double Yrel, double Zrel, string AtomSymbol, string AtomName, double AtomCharge) {try {
	if (Ready != true) {
...
// Atom hinzufügen, relative Atomkoordinaten aus [0,1)
int TKMCJobBase::AddAtom (double Xrel, double Yrel, double Zrel, int ElemID) {try {
	if (Ready != true) {
		cout << "Critical Error: TKMCJob not ready (in TKMCJobBase::AddAtom)" << endl << endl;
		return KMCERR_READY_NOT_TRUE;
	}
...
int TKMCJobBase::AddDoping (string DopedSymbol, string DopedName, double DopedCharge, string DopandSymbol, string DopandName, double DopandCharge, double VacDopRatio) {try {
	if (Ready != true) {
...
// Dotierung hinzufügen, noch keine Konzentrationen
int TKMCJobBase::AddDoping (int DopedID, int DopandID, double VacDopRatio) {try {
	if (Ready != true) {
		cout << "Critical Error: TKMCJob not ready (in TKMCJobBase::AddDoping)" << endl << endl;
		return KMCERR_READY_NOT_TRUE;
	}
...
int TKMCJobBase::MakeStructure () {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearJumps () {try {
	if (Ready != true) {
...
int TKMCJobBase::MakeJumps (int MovShellCount, int JumpStartShellCount, int JumpTSShellCount, int JumpDestShellCount) {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearUniqueJumps () {try {
	if (Ready != true) {
...
int TKMCJobBase::MakeUniqueJumps () {try {
	if (Ready != true) {
...
int TKMCJobBase::SetJumpActive (int JumpID, bool State) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetAtomIgnore (int JumpID, int CoordID, bool State) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetAtomAdditive (int JumpID, int CoordID, bool State) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetAtomActive (int JumpID, int CoordID, bool State) {try {
	if (Ready != true) {
...
// Codierung loeschen
int TKMCJobBase::ClearUniqueCodes () {try {
	if (Ready != true) {
...
int TKMCJobBase::MakeUniqueCodes (int InteractionShellCount) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetInteractionEnergyByCoord (int JumpID, int CoordID, int ID, double Energy) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetInteractionEnergyByInteraction (int WWID, int ID, double Energy) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetCodeEnergy (int JumpID, int CodeID, double Energy) {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearSettings () {try {
	if (Ready != true) {
...
int TKMCJobBase::SetTemperature (double Temperature) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetAttemptFrequency (double Frequency) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetCheckpointFlags (bool WriteCheckpoint, bool LoadCheckpoint) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetEField (double EFieldX, double EFieldY, double EFieldZ, double MaxEField) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetLatticeSize (int LatticeSize) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetAdditionalVacAnz (long long AdditionalVacAnz) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetDopandConcentration (int DopingID, double Conc) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetPrerunOptions (bool DoPrerun, long long PreMCSP, int PreRecordAnz) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetDynNormParameters (bool DoDynNorm, long long DynNormAttemptAnz, int DynNormRecordAnz, int DynNormNum) {try {
	if (Ready != true) {
...
int TKMCJobBase::SetMainKMCOptions (long long MCSP, int MainRecordAnz) {try {
	if (Ready != true) {
...
int TKMCJobBase::MakeSettings () {try {
	if (Ready != true) {
...
int TKMCJobBase::ClearSimulation () {try {
	if (Ready != true) {
...
int TKMCJobBase::InitializeSimulation() {try {
	if (Ready != true) {
...
int TKMCJobBase::SetCheckPointPath(string CheckPointPath) {try {
	if (Ready != true) {
...
int TKMCJobBase::LoadCheckPoint() {try {
	if (Ready != true) {
...
int TKMCJobBase::SaveToStream (ostream &output, int offset) {try {
	if (Ready != true) {
	...
	while (input.good() == true) {
		...
		if ((s_temp == KMCOUT_TKMCJOB_DESCSTART) && (job_found == true)) {
			...
			do {
				...
				if (s_temp != KMCOUT_TKMCJOB_DESCEND) i_Desc.push_back(RightTrim(line));
