...
int TKMCJobOut::GetProjectName (string &Name) {try {
	if (Ready != true) {
...
// Usernamen ausgeben
int TKMCJobOut::GetUserName (string &Name) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetProjectDate (string &CreateDate) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetProjectDescription (string &Description) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetProjectState (int &State) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteToConsole () {try {
	if (Ready != true) {
...
int TKMCJobOut::GetElementCount (int &ElementCount) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetElement (int ElementID, string &ElementSymbol, string &ElementName, double &ElementCharge) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetElement (int ElementID, string &ElementSymbol, string &ElementName, double &ElementCharge, 
							double &Radius, double &ColorR, double &ColorG, double &ColorB) {try {
	if (Ready != true) {
		cout << "Critical Error: TKMCJob not ready (in TKMCJobOut::GetElement)" << endl << endl;
		return KMCERR_READY_NOT_TRUE;
	}
...
int TKMCJobOut::GetMovingElement (string &ElementSymbol, string &ElementName, double &ElementCharge) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetVacancyElement (string &ElementSymbol, string &ElementName, double &ElementCharge) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteElementsToConsole () {try {
	if (Ready != true) {
...
int TKMCJobOut::GetStructureName (string &StructureName) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetBasisByLatticeParam (double &LengthA, double &LengthB, double &LengthC, double &AngleA, double &AngleB, double &AngleC) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetBasisByLatticeVectors (double &Ax, double &Ay, double &Az, double &Bx, double &By, double &Bz, double &Cx, double &Cy, double &Cz) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetAtomCount (int &AtomCount) {try {	
	if (Ready != true) {
...
int TKMCJobOut::GetMovCount (int &MovCount) {try {
	if (Ready != true) {
...
// Atom ausgeben
int TKMCJobOut::GetAtom (int AtomID, double &Xrel, double &Yrel, double &Zrel, int &ElemID) {try {	
	if (Ready != true) {
...
int TKMCJobOut::GetDopingCount (int &DopingCount) {try {
	if (Ready != true) {
...
// Dotierung ausgeben
int TKMCJobOut::GetDoping (int DopingID, int &DopedID, int &DopandID, double &VacDopRatio) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteStructureToConsole () {try {
	if (Ready != true) {
...
int TKMCJobOut::GetShellCounts (int &MovShellCount, int &JumpStartShellCount, int &JumpTSShellCount, int &JumpDestShellCount) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpDirCount (int AtomID, int &DirectionCount) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpStartPos(int AtomID, int DirID, int &x, int &y, int &z, int &s) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpDestPos(int AtomID, int DirID, int &x, int &y, int &z, int &s) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpBackjumpDirID(int AtomID, int DirID, int &BackjumpDirID) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpEnvCount(int AtomID, int DirID, int &EnvAtomCount) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpEnvAtom(int AtomID, int DirID, int EnvAtomID, int &x, int &y, int &z, int &s) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetJumpUniqueJumpID(int AtomID, int DirID, int &UniqueJumpID) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteJumpsToConsole () {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpCount (int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpLength (int JumpID, double &JumpLength) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpActive (int JumpID, bool &JumpState) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpAtomCount (int JumpID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpAtomElement (int JumpID, int CoordID, int &ElemID) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpAtomZylPosition (int JumpID, int CoordID, double &X, double &Y, double &Z) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpAtomStates (int JumpID, int CoordID, bool &IsIgnore, bool &IsAdditive, bool &IsActive) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpAtomDistances (int JumpID, int CoordID, double &StartDist, double &TSDist, double &DestDist) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpWWAtomsCount (int JumpID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpWWAtomsInfo (int JumpID, int WWAtomsID, int &CoordID, int &WWID, int &EnergAnz) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpWWAtomsEnergy (int JumpID, int WWAtomsID, int ID, int &WWElemID, double &WWEnergy) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpUCodesCount (int JumpID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpUCode (int JumpID, int CodeID, string &Code, double &CodeEnergy) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpFCodesCount (int JumpID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetUJumpFCode (int JumpID, int CodeID, string &Code, int &UCodeID) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionShellCount (int &ShellCount) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionCount (int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionDesc (int WWID, int &ElemID, double &StartDist, double &DestDist) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionStartEnvCount (int WWID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionDestEnvCount (int WWID, int &Count) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionStartEnvAtom (int WWID, int ID, int &ElemID, double &X, double &Y, double &Z) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetInteractionDestEnvAtom (int WWID, int ID, int &ElemID, double &X, double &Y, double &Z) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteUJumpToConsole (int JumpID) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteInteractionToConsole (int WWID) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteUniqueJumpsToConsole () {try {
	if (Ready != true) {
...
// Temperatur ausgeben
int TKMCJobOut::GetTemperature (double &Temperature) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetAttemptFrequency (double &Frequency) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetCheckpointFlags (bool &WriteCheckpoint, bool &LoadCheckpoint) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetEFieldSettings (double &EFieldDirX, double &EFieldDirY, double &EFieldDirZ, double &MaxEField) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetEField (double &EFieldX, double &EFieldY, double &EFieldZ) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetLatticeSize (int &LatticeSize) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetAdditionalVacAnz (long long &AdditionalVacAnz) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetTotalVacancyConc (double &Conc) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetTotalVacancyAnz (long long &Anz) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetMovVolConc (double &MovVolConc) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetDopandConc (int ID, double &Conc) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetDopandAnz (int ID, long long &Anz) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetPrerunOptions (bool &DoPrerun, long long &PreMCSP, int &PreRecordAnz)  {try {
	if (Ready != true) {
...
int TKMCJobOut::GetDynNormParameters (bool &DoDynNorm, long long &DynNormAttemptAnz, int &DynNormRecordAnz, int &DynNormNum) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetMainKMCOptions (long long &MCSP, int &MainRecordAnz) {try {
	if (Ready != true) {
...
int TKMCJobOut::WriteSettingsToConsole () {try {
	if (Ready != true) {
...
int TKMCJobOut::GetResultSummaryDesc(string ValDelimiter, string &SummaryDesc) {try {
	if (Ready != true) {
...
int TKMCJobOut::GetResultSummary(string ValDelimiter, string &Summary) {try {
	if (Ready != true) {
