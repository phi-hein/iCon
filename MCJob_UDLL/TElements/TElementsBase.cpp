...
int TElementsBase::AddElement(string_view i_symbol, string_view i_name, double i_charge)
{
	if (Ready != false)
	{
	...
	// Eingabe hinzufuegen
	Symbol.emplace_back(Trim(i_symbol));
	Name.emplace_back(Trim(i_name));
...
int TElementsBase::SetMovingElement(string_view i_symbol, string_view i_name, double i_charge)
{
	if (Ready != false)
	{
